...
##### First floor#####
ops.mass(2,5.6,5.6,5.6,0,0,0)
ops.mass(6,8.13,8.13,8.13,0,0,0)
ops.mass(10,8.27,8.27,8.27,0,0,0)
ops.mass(14,5.74,5.74,5.74,0,0,0)
ops.mass(18,8.26,8.26,8.26,0,0,0)
ops.mass(22,11.03,11.03,11.03,0,0,0)
ops.mass(26,10.88,10.88,10.88,0,0,0)
ops.mass(30,5.74,5.74,5.74,0,0,0)
ops.mass(34,5.53,5.53,5.53,0,0,0)
ops.mass(38,8.12,8.12,8.12,0,0,0)
ops.mass(42,5.42,5.42,5.42,0,0,0)

#############second floor#################
ops.mass(3,5.49,5.49,5.49,0,0,0)
ops.mass(7,8.01,8.01,8.01,0,0,0)
ops.mass(11,8.15,8.15,8.15,0,0,0)
ops.mass(15,5.62,5.62,5.62,0,0,0)
ops.mass(19,8.14,8.14,8.14,0,0,0)
ops.mass(23,10.91,10.91,10.91,0,0,0)
ops.mass(27,10.76,10.76,10.76,0,0,0)
ops.mass(31,5.62,5.62,5.62,0,0,0)
ops.mass(35,5.41,5.41,5.41,0,0,0)
ops.mass(39,8,8,8,0,0,0)
ops.mass(43,5.3,5.3,5.3,0,0,0)

##########3rd floor##############
ops.mass(4,2.87,2.87,2.87,0,0,0)
ops.mass(8,4.48,4.48,4.48,0,0,0)
ops.mass(12,4.57,4.57,4.57,0,0,0)
ops.mass(16,2.96,2.96,2.96,0,0,0)
ops.mass(20,4.57,4.57,4.57,0,0,0)
ops.mass(24,6.91,6.91,6.91,0,0,0)
ops.mass(28,6.23,6.23,6.23,0,0,0)
ops.mass(32,2.96,2.96,2.96,0,0,0)
ops.mass(36,2.83,2.83,2.83,0,0,0)
ops.mass(40,4.47,4.47,4.47,0,0,0)
ops.mass(44,2.76,2.76,2.76,0,0,0)
# RESTRAINTS
...
Col230x230_ST = 8   ##### top column ko corner
Col230x230_IT = 9 # top interior
# Define dimensions
pi = 3.14
...
FiberBuilder.JacketBuilder(Col270x270_FnC, h_col1, b_col1, r_col, C_conf, C_unconf, R_steel, Rebar_16, 0.000000001, jack_unconfinedID,Jacket_confinedID,JbarAreaInt,JbarAreaCorner,thickness,jacket_Cover)
FiberBuilder.JacketBuilder(Col270x270_CC, h_col1, b_col1, r_col, C_conf, C_unconf, R_steel, Rebar_12, Rebar_12, jack_unconfinedID,Jacket_confinedID,JbarAreaInt,JbarAreaCorner,thickness,jacket_Cover)
FiberBuilder.JacketBuilder(Col230x230_S, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_16, 0.000000001, jack_unconfinedID,Jacket_confinedID,0.0000000001,JbarAreaCorner,thickness,jacket_Cover)
FiberBuilder.JacketBuilder(Col230x230_SI, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_12, Rebar_12, jack_unconfinedID,Jacket_confinedID,0.0000000001,JbarAreaCorner,thickness,jacket_Cover)
FiberBuilder.JacketBuilder(Col230x230_T, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_12, 0.0000000001, jack_unconfinedID,Jacket_confinedID,0.000000001,JbarAreaInt,thickness,jacket_Cover)
FiberBuilder.JacketBuilder(Col230x230_ST, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_16, 0.0000000001, jack_unconfinedID,Jacket_confinedID,0.000000001,JbarAreaInt,thickness,jacket_Cover)
FiberBuilder.JacketBuilder(Col230x230_IT, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_12, 0.0000000001, jack_unconfinedID,Jacket_confinedID,0.000000001,JbarAreaCorner,thickness,jacket_Cover)
...
####### second  Floor ####################
#ops.element('nonlinearBeamColumn', eleTag, i, j, NI, Col300x300, PDTransCol)
ops.element('nonlinearBeamColumn',23 ,3 , 4, NI, Col230x230_ST, PDTransCol)
...
ops.element('nonlinearBeamColumn',26 ,15, 16,NI, Col230x230_ST, PDTransCol)
ops.element('nonlinearBeamColumn',27 ,19, 20,NI, Col230x230_T, PDTransCol)
ops.element('nonlinearBeamColumn',28 ,23, 24,NI, Col230x230_IT, PDTransCol)
ops.element('nonlinearBeamColumn',29 ,27, 28,NI, Col230x230_ST, PDTransCol)
ops.element('nonlinearBeamColumn',30 ,31, 32,NI, Col230x230_ST, PDTransCol)
ops.element('nonlinearBeamColumn',31 ,35, 36,NI, Col230x230_ST, PDTransCol)
ops.element('nonlinearBeamColumn',32 ,39, 40,NI, Col230x230_T, PDTransCol)
ops.element('nonlinearBeamColumn',33 ,43, 44,NI, Col230x230_ST, PDTransCol)
