...
os.chdir(r"E:\4th year project\opensees\Pushover all typology\Pre Engineered Buildings\column jacketing\Column jacket 50mm")
# START ANALYSIS
import Gravity
...
plt.figure(figsize=(10, 6))
plt.plot(d500, sum_reactions/2427, label='Base shear/Total weight vs. Average Displacement (m) ')
plt.xlabel('Average Displacement (m)')
...
data = {
    ...
    'Base/weight': sum_reactions/2427
}
