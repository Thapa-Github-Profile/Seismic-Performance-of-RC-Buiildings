...
import os
os.chdir(r"E:\4th year project\opensees\Pushover all typology\Pre Engineered Buildings\steel jacketing")
...
FiberBuilder.AngleBuilder(Col270x270_FnC, h_col1, b_col1, r_col, C_conf, C_unconf, R_steel, Rebar_16, 0.000000001,Angle_Material,0.05,0.005 )
FiberBuilder.AngleBuilder(Col270x270_CC, h_col1, b_col1, r_col, C_conf, C_unconf, R_steel, Rebar_12, Rebar_12, Angle_Material,0.05,0.005)
FiberBuilder.AngleBuilder(Col230x230_S, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_16, 0.000000001,Angle_Material,0.05,0.005 )
FiberBuilder.AngleBuilder(Col230x230_SI, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_12, Rebar_12, Angle_Material,0.05,0.005)
FiberBuilder.AngleBuilder(Col230x230_T, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_12, 0.0000000001,Angle_Material,0.05,0.005)
FiberBuilder.AngleBuilder(Col230x230_ST, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_16, 0.0000000001, Angle_Material,0.05,0.005)
FiberBuilder.AngleBuilder(Col230x230_IT, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_12, 0.0000000001,Angle_Material,0.05,0.005)
