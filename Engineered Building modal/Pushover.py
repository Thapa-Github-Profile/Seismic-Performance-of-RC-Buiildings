...
d4000 = displacements_data[:, 2]
d3000 = displacements_data[:, 3]
...
plt.plot(d5000, sum_reactions/2280, label='Sum of Reactions vs. Displacements of Masternode')
plt.xlabel('Average Displacement (m)')
...
data = {
    ...
    'Base/weight': sum_reactions/2280
}
