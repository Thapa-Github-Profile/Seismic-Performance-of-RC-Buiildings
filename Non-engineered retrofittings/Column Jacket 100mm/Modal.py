...
FiberBuilder.JacketBuilder(Col230x230_G, h_col, b_col, cover_Col, C_conf, C_unconf, R_steel, Rebar_16, 0.00000001, jack_unconfinedID,Jacket_confinedID,JbarAreaInt,JbarAreaCorner,thickness,jacket_Cover)
FiberBuilder.JacketBuilder(Col230x230_F, h_col, b_col, cover_Col, C_conf, C_unconf, R_steel, Rebar_12, 0.00000001, jack_unconfinedID,Jacket_confinedID,JbarAreaInt,JbarAreaCorner,thickness,jacket_Cover)
FiberBuilder.JacketBuilder(Col230x230_S, h_col, b_col, cover_Col, C_conf, C_unconf, R_steel, Rebar_12, 0.00000001, jack_unconfinedID,Jacket_confinedID,0.00000000001,JbarAreaCorner,thickness,jacket_Cover)

FiberBuilder.JacketBuilder(Col230x230_F1, h_col, b_col, cover_Col, C_conf, C_unconf, R_steel, Rebar_12, 0.00000001, jack_unconfinedID,Jacket_confinedID,0.000000001,JbarAreaCorner,thickness,jacket_Cover)
...
ops.element('nonlinearBeamColumn',1 ,1 , 2, NI, Col230x230_S, PDTransCol)
...
ops.element('nonlinearBeamColumn',5 ,17, 18,NI, Col230x230_S, PDTransCol)
...
####### First Floor ####################
#ops.element('nonlinearBeamColumn', eleTag, i, j, NI, Col300x300, PDTransCol)
ops.element('nonlinearBeamColumn',12 ,2 , 3, NI, Col230x230_F1, PDTransCol)
ops.element('nonlinearBeamColumn',13 ,6 , 7, NI, Col230x230_F , PDTransCol)
ops.element('nonlinearBeamColumn',14 ,10 ,11,NI, Col230x230_F, PDTransCol)
ops.element('nonlinearBeamColumn',15 ,14, 15,NI, Col230x230_F, PDTransCol)
ops.element('nonlinearBeamColumn',16 ,18, 19,NI, Col230x230_F1, PDTransCol)
ops.element('nonlinearBeamColumn',17 ,22, 23,NI, Col230x230_F1, PDTransCol)
ops.element('nonlinearBeamColumn',18 ,26, 27,NI, Col230x230_F, PDTransCol)
ops.element('nonlinearBeamColumn',19 ,30, 31,NI, Col230x230_F1, PDTransCol)
ops.element('nonlinearBeamColumn',20 ,34, 35,NI, Col230x230_F, PDTransCol)
ops.element('nonlinearBeamColumn',21 ,38, 39,NI, Col230x230_F, PDTransCol)
ops.element('nonlinearBeamColumn',22 ,42, 43,NI, Col230x230_F1, PDTransCol)

################column elements##################
####### second  Floor ####################
#ops.element('nonlinearBeamColumn', eleTag, i, j, NI, Col300x300, PDTransCol)
ops.element('nonlinearBeamColumn',23 ,3 , 4, NI, Col230x230_S, PDTransCol)
ops.element('nonlinearBeamColumn',24 ,7 , 8, NI, Col230x230_S, PDTransCol)
ops.element('nonlinearBeamColumn',25 ,11, 12,NI, Col230x230_S, PDTransCol)
ops.element('nonlinearBeamColumn',26 ,15, 16,NI, Col230x230_S, PDTransCol)
ops.element('nonlinearBeamColumn',27 ,19, 20,NI, Col230x230_S, PDTransCol)
ops.element('nonlinearBeamColumn',28 ,23, 24,NI, Col230x230_S, PDTransCol)
...
ops.element('nonlinearBeamColumn',32 ,39, 40,NI, Col230x230_S, PDTransCol)
