...
ops.uniaxialMaterial('Steel01', fiberid, 4318000, 260000000, 0.0000001)
...
coverID=C_unconf
steelID=R_steel
jackcoverID = C_unconf
barAreaCorner=0.000314
barAreaInt=0.000114
barAreaIntrc=0.00000000000001
coverY = HSec / 2.0
coverZ = BSec / 2.0
coreY = coverY - cover
coreZ = coverZ - cover
...
ColumnBuilder = [['section', 'Fiber', 3, '-GJ', 10000000],
            ...
            # ['patch', 'rect', coverID, 6, 6, -coverY, coverZ, coverY, -coverZ]]
            ...
            ['layer','straight', steelID, 2, barAreaInt, -coreY, 0, coreY, 0],  # intermediate skin reinforcement -y
...
opsv.plot_fiber_section(ColumnBuilder,1, matcolor= matcolor)
plt.axis('equal')
plt.show()
...
ColumnJacketBuilder = [['section', 'Fiber', 3, '-GJ', 10000000],
            ...
            ['layer','straight', steelID, 2, barAreaCorner, coreY, coreZ, coreY, -coreZ],  # top layer reinforcement
            ['layer','straight', steelID, 2, barAreaCorner, -coreY, coreZ, -coreY, -coreZ],  # bottom layer reinforcement
            ['layer','straight', steelID, 1, barAreaIntrc, 0, -coverZplusjacket+jacket_Cover, coverYplusjacket, -coverZplusjacket],  #Jacket intermediate skin reinforcement -z
            ['layer','straight', steelID, 1, barAreaIntrc, 0, coverZplusjacket-jacket_Cover, coverYplusjacket, -coverZplusjacket],  #Jacket intermediate skin reinforcement +z
            ['layer','straight', steelID, 1, barAreaIntrc, coverYplusjacket-jacket_Cover, 0, coverYplusjacket-jacket_Cover, coverZplusjacket-jacket_Cover],  #Jacket intermediate skin reinforcement +y
            ['layer','straight', steelID, 1, barAreaIntrc, -coverYplusjacket+jacket_Cover, 0, coverYplusjacket-jacket_Cover, -coverZplusjacket-jacket_Cover], #Jacket intermediate skin reinforcement -y
