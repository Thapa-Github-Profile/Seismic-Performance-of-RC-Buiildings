...
import os
os.chdir(r"E:\4th year project\opensees\Pushover all typology\Non engineered buildings\Non engineered modal")
...
##### First floor#####
ops.mass(2,6.68,6.68,6.68,0,0,0)
ops.mass(6,9.6,9.6,9.6,0,0,0)
ops.mass(10,9.77,9.77,9.77,0,0,0)
ops.mass(14,6.83,6.83,6.83,0,0,0)
ops.mass(18,9.75,9.75,9.75,0,0,0)
ops.mass(22,12.6,12.6,12.6,0,0,0)
ops.mass(26,12.79,12.79,12.79,0,0,0)
ops.mass(30,6.84,6.84,6.84,0,0,0)
ops.mass(34,6.59,6.59,6.59,0,0,0)
ops.mass(38,9.58,9.58,9.58,0,0,0)
ops.mass(42,6.45,6.45,6.45,0,0,0)
...
FiberBuilder.ColumnBuilder(Col230x230_4x16, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_16, 0.000000001) 
FiberBuilder.ColumnBuilder(Col230x230_4x12, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_12, 0.00000001)
...
ops.element('nonlinearBeamColumn',1 ,1 , 2, NI, Col230x230_4x16, PDTransCol)
ops.element('nonlinearBeamColumn',2 ,5 , 6, NI, Col230x230_4x16, PDTransCol)
ops.element('nonlinearBeamColumn',3 ,9 , 10,NI, Col230x230_4x16, PDTransCol)
ops.element('nonlinearBeamColumn',4 ,13, 14,NI, Col230x230_4x16, PDTransCol)
ops.element('nonlinearBeamColumn',5 ,17, 18,NI, Col230x230_4x16, PDTransCol)
ops.element('nonlinearBeamColumn',6 ,21, 22,NI, Col230x230_4x16, PDTransCol)
ops.element('nonlinearBeamColumn',7 ,25, 26,NI, Col230x230_4x16, PDTransCol)
ops.element('nonlinearBeamColumn',8 ,29, 30,NI, Col230x230_4x16, PDTransCol)
ops.element('nonlinearBeamColumn',9 ,33, 34,NI, Col230x230_4x16, PDTransCol)
ops.element('nonlinearBeamColumn',10 ,37, 38,NI, Col230x230_4x16, PDTransCol)
ops.element('nonlinearBeamColumn',11 ,41, 42,NI, Col230x230_4x16, PDTransCol)
